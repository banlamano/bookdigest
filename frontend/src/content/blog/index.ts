// Blog post registry. AUTO-MAINTAINED by the generator
// (backend/src/scripts/generate-blog-post.ts) — it inserts a new import and
// array entry at the generator markers below. Hand-edits are fine as long as
