...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'pricing.noChargeNow': 'No charge today · Cancel anytime',
    'pricing.teamBadge': 'For Teams · 5 Seats',
    'pricing.teamTitle': 'Team Plan',
    'pricing.teamSubtitle': 'Premium for your whole team — perfect for startups, book clubs, and HR teams.',
    'pricing.teamFeature1': 'Up to 5 user seats included',
    'pricing.teamFeature2': 'All Premium features for every member',
    'pricing.teamFeature3': 'One invoice for the whole team',
    'pricing.teamPriceSuffix': '/ month · €5.99 per seat',
    'pricing.teamCta': 'Get Team Plan',
    'pricing.teamFootnote': "We'll email you within 24h to set up your seats.",
    'pricing.premiumYearly': 'Premium Yearly',
    'pricing.perYear': 'per year',
    'pricing.save33': 'Save 33%',
    'pricing.mostPopular': 'Most Popular · Save 33%',
    'pricing.perMonthEquiv': '= €6.67/month',
    'pricing.lowestPerMonth': 'Lowest cost per month',
    ...
    'emailPopup.namePlaceholder': 'First name (optional)',
  ...
  de: {
    ...
    'bookDetail.minRead': 'Min. Lesezeit',
    'bookDetail.audioAvailable': 'Audio verfügbar',
    'bookDetail.audioPremium': 'Audio (Premium)',
    'bookDetail.startReading': 'Zusammenfassung lesen',
    ...
    'pricing.startTrial': '7 Tage kostenlos testen',
    'pricing.trialBadge': '7 Tage kostenlos',
    'pricing.noChargeNow': 'Keine Belastung heute · Jederzeit kündbar',
    'pricing.teamBadge': 'Für Teams · 5 Plätze',
    'pricing.teamTitle': 'Team-Plan',
    'pricing.teamSubtitle': 'Premium für dein ganzes Team — ideal für Startups, Buchclubs und HR-Teams.',
    'pricing.teamFeature1': 'Bis zu 5 Nutzerplätze enthalten',
    'pricing.teamFeature2': 'Alle Premium-Funktionen für jedes Mitglied',
    'pricing.teamFeature3': 'Eine Rechnung für das ganze Team',
    'pricing.teamPriceSuffix': '/ Monat · 5,99 € pro Platz',
    'pricing.teamCta': 'Team-Plan holen',
    'pricing.teamFootnote': 'Wir melden uns innerhalb von 24 Std. zur Einrichtung deiner Plätze.',
    'pricing.premiumYearly': 'Premium Jährlich',
    'pricing.perYear': 'pro Jahr',
    'pricing.save33': '33% sparen',
    'pricing.mostPopular': 'Beliebteste · 33% sparen',
    'pricing.perMonthEquiv': '= 6,67 €/Monat',
    'pricing.lowestPerMonth': 'Niedrigste Kosten pro Monat',
    ...
    'emailPopup.namePlaceholder': 'Vorname (optional)',
