...
export const metadata: Metadata = {
  ...
  // Icons are auto-generated by Next.js from app/icon.tsx and
  // app/apple-icon.tsx — those routes produce proper PNGs at build
  // time via ImageResponse. The old manual declaration pointed at
  // a broken 1.6KB icon-192.png that browsers refused to render.
  robots: {
    index: true,
    follow: true,
    googleBot: {
