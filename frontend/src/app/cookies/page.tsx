          ...
          {isDe ? (
            <>
              ...
              <p>
                ...
                Sie helfen uns dabei, Ihnen ein besseres Erlebnis zu bieten, indem wir Ihre Präferenzen speichern und verstehen, wie Sie unseren Dienst nutzen.
              </p>

              <h2>2. Wie wir Cookies verwenden</h2>
              <h3>2.1 Erforderliche Cookies</h3>
              <ul>
                <li><strong>Authentifizierung:</strong> Bleiben Sie angemeldet, während Sie auf der Website navigieren.</li>
                <li><strong>Sicherheit:</strong> Schützen Sie Ihr Konto und erkennen Sie betrügerische Aktivitäten.</li>
              </ul>

              <h3>2.2 Analytische Cookies</h3>
              <ul>
                <li><strong>Google Analytics:</strong> Wir verfolgen Seitenaufrufe und Nutzerverhalten.</li>
                <li><strong>Leistungsüberwachung:</strong> Wir identifizieren technische Probleme.</li>
              </ul>

              <h3>2.3 Funktionale Cookies</h3>
              <ul>
                <li><strong>Themen-Einstellung:</strong> Speichert Ihre Wahl zwischen Dark- und Light-Mode.</li>
                <li><strong>Lesefortschritt:</strong> Speichert, wo Sie in einem Buch aufgehört haben.</li>
                <li><strong>Sprachauswahl:</strong> Merkt sich Ihre bevorzugte Sprache.</li>
              </ul>

              <h2>3. Verwalten von Cookies</h2>
              <p>Sie können Cookies über Ihre Browsereinstellungen steuern.</p>

              <h2>4. Kontakt</h2>
              <p>Bei Fragen kontaktieren Sie uns unter privacy@bookdigest.com.</p>
            </>
          ) : (
            <>
