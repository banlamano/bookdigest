...
export default function CategoriesClient({
  ...
  /** Server-fetched categories so the shipped HTML already contains the category links. */
  ...
  // Fall back to the server-fetched list so the SSR pass renders real links.
  const categories = data?.data?.data?.categories || initialCategories;
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Categories Grid — skeletons only when we have nothing to show, so the
            server-rendered list stays in the HTML for crawlers. */}
